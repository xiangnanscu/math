...
$\blacksquare$ 如,空间 $\mathbf{m},{\ell }^{p}\left( {1 \leq  p < \infty }\right) ,\mathbf{c},\mathcal{B}\left( T\right) ,\mathcal{C}\left( \left\lbrack  {a, b}\right\rbrack  \right) ,{\mathcal{C}}^{\left( k\right) }\left( \left\lbrack  {a, b}\right\rbrack  \right) ,{L}^{p}\left( {a, b}\right) \left( {1 \leq  p < \infty }\right)$ 等都是完备空间.
