...
$$
$\blacksquare$ = {\int }_{\left( C\right) }{\varepsilon }^{2}\left( {x\left( t\right) , y\left( t\right) ;{a}_{1},\cdots ,{a}_{n}}\right) \mathrm{d}t = \min , \tag{19.143a}
$$
...
$$
$\blacksquare$ = {\iint }_{\left( G\right) }{\varepsilon }^{2}\left( {x, y;{a}_{1},\cdots ,{a}_{n}}\right) \mathrm{d}x\mathrm{\;d}y = \min  \tag{19.143b}
$$
